...
namespace Fungus
{
    ...
    [AddComponentMenu("")]
    [ExecuteInEditMode]
    public class FungusShit : iTweenCommand
    {
        public GameObject OrigSprite;
        ...
        {
            //scene.GetComponent<Player>().CurrentSprites[1, scene.GetComponent<Player>().FindSprite(OrigSprite.name)] = x;
            //scene.GetComponent<Player>().CurrentSprites[2, scene.GetComponent<Player>().FindSprite(OrigSprite.name)] = y;
            //UnityEngine.Debug.Log(scene.GetComponent<test>().a);

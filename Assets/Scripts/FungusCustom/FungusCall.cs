...
namespace Fungus
{
    ...
    [CommandInfo("Flow",
                 ...
                 "Execute another block in the same Flowchart as the command, or in a different Flowchart.")]
    [AddComponentMenu("")]
    public class FungusCall : Command, IBlockCaller
    {
       ...
       // [Tooltip("Name of the Block to call")]
       // [SerializeField] protected StringData blockName = new StringData("");
        ...
        {  
            ...
            UnityEngine.Debug.Log("Стартовый индекс для загрузки: " + startIndex);
        ...
        {
            //targetBlock = targetFlowchart.FindBlock(blockName.Value);
            if (targetBlock != null)
            {

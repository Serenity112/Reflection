...
namespace Fungus
{
    ...
    public class FungusSay : Command
    {
        ...
        [Tooltip("Ебать")]
        [SerializeField] protected bool DivideSent = false;
        ...
        [SerializeField] protected bool waitForVO1 = false;
        ...
        {
            //obj1.GetComponent<Player>().DialogSaveUpdate();
            UnityEngine.Debug.Log("AABB1");
